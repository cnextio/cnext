...
function getBabelConfig({ babelConfig, cwd, forcedOptions = {}, defaultOptions = {}, browserslist, phase, hook }) {
    return (filename) => {
        ...
        const combined = Object.assign(Object.assign(Object.assign(Object.assign({}, otherDefaultOptions), options), otherForcedOptions), { presets: combineConfigItems(((_a = options.presets) !== null && _a !== void 0 ? _a : []), defaultPresets == null ? undefined : (_c = (_b = loadPartialConfig(Object.assign({ presets: defaultPresets }, configFileOption))) === null || _b === void 0 ? void 0 : _b.options.presets) !== null && _c !== void 0 ? _c : undefined, forcedPresets == null ? undefined : (_e = (_d = loadPartialConfig(Object.assign({ presets: forcedPresets }, configFileOption))) === null || _d === void 0 ? void 0 : _d.options.presets) !== null && _e !== void 0 ? _e : undefined, phase === "chunk"), plugins: combineConfigItems(((_f = options.plugins) !== null && _f !== void 0 ? _f : []), defaultPlugins == null ? undefined : (_h = (_g = loadPartialConfig(Object.assign({ plugins: defaultPlugins }, configFileOption))) === null || _g === void 0 ? void 0 : _g.options.plugins) !== null && _h !== void 0 ? _h : undefined, forcedPlugins == null ? undefined : (_k = (_j = loadPartialConfig(Object.assign({ plugins: forcedPlugins }, configFileOption))) === null || _j === void 0 ? void 0 : _j.options.plugins) !== null && _k !== void 0 ? _k : undefined, phase === "chunk") });
...
function createExportSpecifierFromNameAndModifiers({ name, modifiers, typescript, factory }) {
    if (hasDefaultExportModifier(modifiers, typescript)) {
        const propertyNameText = name;
        const nameText = "default";
        const exportSpecifier = factory.createExportSpecifier(propertyNameText === nameText ? undefined : factory.createIdentifier(propertyNameText), factory.createIdentifier(nameText));
        return {
            exportSpecifier,
...
function visitImportDeclaration$4(options) {
    ...
    return [
        factory.updateImportDeclaration(node, node.decorators, node.modifiers, factory.updateImportClause(node.importClause, first.importClause.isTypeOnly, first.importClause.name, first.importClause.namedBindings), node.moduleSpecifier),
        ...other
    ];
}
    ...
    for (const [module, collections] of namedImportsFromModulesMap) {
        ...
        for (const collection of collections) {
            ...
            importDeclarationsForModule.push(preserveParents(factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports(collection.map(record => record.propertyName !== record.alias
                ...
                : factory.createImportSpecifier(undefined, factory.createIdentifier(record.alias))))), factory.createStringLiteral(ensureHasLeadingDotAndPosix(module))), { typescript }));
        }
    }
...
function getMergedExportDeclarationsForModules(options) {
    ...
    for (const [specifier, exportedBindings] of moduleSpecifierToAliasedExportedBindings) {
        ...
        exportDeclarationsForModule.push(preserveParents(factory.createExportDeclaration(undefined, undefined, false, factory.createNamedExports(exportSpecifiers), specifier == null ? undefined : factory.createStringLiteral(ensureHasLeadingDotAndPosix(specifier))), { typescript }));
    }
    ...
    for (const [specifier, names] of namedNamespaceExportsFromModulesMap) {
        ...
        for (const name of names) {
            exportDeclarationsForModule.push(preserveParents(factory.createExportDeclaration(undefined, undefined, false, factory.createNamespaceExport(factory.createIdentifier(name)), factory.createStringLiteral(ensureHasLeadingDotAndPosix(specifier))), { typescript }));
        }
    }
...
function visitExportDeclaration$4(options) {
    ...
    if (node.exportClause == null || ((_a = typescript.isNamespaceExport) === null || _a === void 0 ? void 0 : _a.call(typescript, node.exportClause))) {
        ...
        const namedImports = factory.createNamedImports(exportedBindings.map(([name, deconflictedName]) => factory.createImportSpecifier(name === deconflictedName ? undefined : factory.createIdentifier(name), factory.createIdentifier(deconflictedName))));
        ...
        const namedExports = factory.createNamedExports(exportedBindings.map(([name, deconflictedName]) => factory.createExportSpecifier(name === deconflictedName ? undefined : factory.createIdentifier(deconflictedName), factory.createIdentifier(name))));
...
function generateExportDeclarations(options, exportDeclarations = []) {
    ...
    for (const symbol of exportedSymbols) {
        ...
        // Otherwise, we can just add an ExportDeclaration with an ExportSpecifier
            ...
            const exportSpecifier = factory.createExportSpecifier(symbol.propertyName.text === symbol.name.text ? undefined : factory.createIdentifier(symbol.propertyName.text), factory.createIdentifier(symbol.name.text));
            exportDeclarations.push(preserveParents(factory.createExportDeclaration(undefined, undefined, false, factory.createNamedExports([exportSpecifier]), symbol.moduleSpecifier == null || generatedModuleSpecifier == null || matchingSourceFile != null ? undefined : factory.createStringLiteral(generatedModuleSpecifier)), { typescript }));
...
function visitExportDeclaration$3(options) {
    ...
    if (matchingSourceFile == null) {
        ...
        return preserveMeta(factory.updateExportDeclaration(contResult, contResult.decorators, contResult.modifiers, contResult.isTypeOnly, contResult.exportClause, factory.createStringLiteral(updatedModuleSpecifier)), contResult, options);
    }
    ...
    return preserveMeta(factory.updateExportDeclaration(contResult, contResult.decorators, contResult.modifiers, contResult.isTypeOnly, contResult.exportClause, undefined), contResult, options);
}
...
function visitImportDeclaration$2(options) {
    ...
    return preserveMeta(factory.updateImportDeclaration(contResult, contResult.decorators, contResult.modifiers, contResult.importClause, factory.createStringLiteral(updatedModuleSpecifier)), contResult, options);
}
        ...
        case typescript.SyntaxKind.ClassExpression: {
            return [
                preserveParents(factory.createModuleDeclaration(undefined, undefined, factory.createIdentifier(moduleBinding), factory.createModuleBlock([
                    factory.createExportDeclaration(undefined, undefined, false, factory.createNamedExports([factory.createExportSpecifier(undefined, factory.createIdentifier(propertyName))]))
                ])), { typescript }),
    ...
    if (exportedSymbol != null) {
        ...
        if (exportedSymbol.moduleSpecifier != null &&
            ...
            options.prependNodes(preserveParents(factory.createImportDeclaration(undefined, undefined, factory.createImportClause(false, undefined, factory.createNamedImports([
                factory.createImportSpecifier(propertyName.text === "default"
...
function visitExportSpecifier(options) {
    ...
    if (namedExportedSymbol != null) {
        ...
        if (namedExportedSymbol.moduleSpecifier != null &&
            ...
            options.prependNodes(preserveParents(factory.createExportDeclaration(undefined, undefined, false, factory.createNamedExports([
                factory.createExportSpecifier(propertyName.text === "default"
                    ? factory.createIdentifier("default")
            ...
            return preserveMeta(factory.updateExportSpecifier(contResult, !("propertyName" in namedExportedSymbol) || namedExportedSymbol.propertyName == null || namedExportedSymbol.propertyName.text === contResult.name.text
                ? undefined
...
function typescriptRollupPlugin(pluginInputOptions = {}) {
    ...
    const filter = (id) => internalFilter(id) || internalFilter(path.normalize(id)) || internalFilter(path.native.normalize(id));
    /**
    ...
    return {
        ...
        async renderChunk(code, chunk, outputOptions) {
            ...
            const transpilationResult = await transformAsync(updatedCode, Object.assign(Object.assign(Object.assign({}, config), { filenameRelative: ensureRelative(cwd, chunk.fileName) }), (updatedMap == null
                ? {}
                : {
        ...
        async transform(code, file) {
            ...
            sourceDescription =
                !host.isSupportedFileName(normalizedFile) || isJsInDisguise
                    ? babelConfigResult != null
                        ? sourceDescription !== null && sourceDescription !== void 0 ? sourceDescription : { code, map: undefined }
                        : sourceDescription
                    : (() => {
            ...
            if (sourceDescription == null) {
                ...
                // Otherwise, pass it on to Babel to perform the rest of the transpilation steps
                    ...
                    const transpilationResult = await transformAsync(sourceDescription.code, Object.assign(Object.assign({}, babelConfigResult.config), { filenameRelative: ensureRelative(cwd, normalizedFile), inputSourceMap: typeof sourceDescription.map === "string" ? JSON.parse(sourceDescription.map) : sourceDescription.map }));
                    if (transpilationResult == null || transpilationResult.code == null) {
                        return sourceDescription;
                    }
                    // Return the results

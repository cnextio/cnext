...
export const baseTheme = /*@__PURE__*/ EditorView.baseTheme({
    ...
    ".cm-completionInfo::-webkit-scrollbar-thumb:hover": {
        background: "#bbb",
    },
    ".cm-completionInfo::-webkit-scrollbar:horizontal": {
        height: "5px",
    },
    ".cm-completionInfo::-webkit-scrollbar-thumb:horizontal": {
        background: "#ccc",
        borderRadius: "2px",
    },
    ".cm-completionInfo::-webkit-scrollbar-thumb:horizontal:hover": {
        background: "#bbb",
    },
